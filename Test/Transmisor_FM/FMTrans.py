...
class FMTrans(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Transmiter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Transmiter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FMTrans")
        ...
        self.quadrature_rate = quadrature_rate = 192000
        self.frec = frec = 88600000
        ...
        self._frec_range = Range(88000000, 108000000, 100000, 88600000, 200)
        ...
        self.osmosdr_sink_0.set_sample_rate(quadrature_rate)
        self.osmosdr_sink_0.set_center_freq(frec, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_wfm_tx_0, 0), (self.qtgui_freq_sink_x_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.frec, self.samp_rate)
    ...
    def set_quadrature_rate(self, quadrature_rate):
        ...
        self.osmosdr_sink_0.set_sample_rate(self.quadrature_rate)
        self.qtgui_freq_sink_x_1.set_frequency_range(self.frec, self.quadrature_rate)
    ...
    def set_frec(self, frec):
        self.frec = frec
        self.osmosdr_sink_0.set_center_freq(self.frec, 0)
        self.qtgui_freq_sink_x_1.set_frequency_range(self.frec, self.quadrature_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.frec, self.samp_rate)
...
def main(top_block_cls=FMTrans, options=None):
