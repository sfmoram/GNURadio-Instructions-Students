...
class UHD_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "UHD_1")
        ...
        self.uhd_usrp_source_1.set_center_freq(Frec_center, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.Frec_center, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.Frec_center, self.samp_rate)
    ...
    def set_Frec_center(self, Frec_center):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.Frec_center, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.Frec_center, self.samp_rate)
        self.uhd_usrp_source_1.set_center_freq(self.Frec_center, 0)





def main(top_block_cls=UHD_1, options=None):
